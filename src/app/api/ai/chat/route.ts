import {
	...
	sanitizePrompt,
	validateAIResponse,
} from '@/lib/ai-security/input-validation';
import { chatRateLimit, withRateLimit } from '@/lib/ai-security/rate-limiting';
...
// Message schema for chat validation
const chatMessageSchema = z.object({
	...
	metadata: z
		.object({
			...
			sourceType: z.enum(['manual', 'suggestion', 'auto']).optional(),
		})
		.optional(),
});

// Context schema for mind map integration
