...
import { ShareAccessValidation, CreateGuestUserRequest } from "@/types/sharing-types";
import { AlertCircle, Brain, CheckCircle, Eye, Edit, MessageSquare, RefreshCw, Users } from "lucide-react";
...
export default function JoinRoomPage({ params }: JoinRoomPageProps) {
  ...
  const [step, setStep] = useState<'validating' | 'guest-signup' | 'joining' | 'success' | 'error'>('validating');
      ...
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="space-y-2">
            <h2 className="text-xl font-semibold text-zinc-100">Validating Room Code</h2>
        ...
        >
          <Card className="border-red-900/50 bg-zinc-900">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-red-400">Unable to Join Room</CardTitle>
              <CardDescription>
                {validation?.error_message || sharingError?.message || "Invalid or expired room code"}
              </CardDescription>
            </CardHeader>
    ...
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-bold text-zinc-100">Welcome to the Room!</h2>
    ...
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="space-y-2">
            <h2 className="text-xl font-semibold text-zinc-100">Joining Room</h2>
            <p className="text-zinc-400">Setting up your collaboration session...</p>
          </div>
        </motion.div>
      </div>
    );
      ...
      >
        <Card className="border-zinc-800 bg-zinc-900">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-zinc-100">Join Collaboration Room</CardTitle>
            <CardDescription>
              You're joining a shared mind map. Enter your details to continue.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setGuestInfo(prev => ({ ...prev, display_name: e.target.value }))}
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-zinc-500">
                  We'll use this to convert your session to a full account later
                </p>
              </div>
            </div>
            ...
            <div className="text-center space-y-3">
              <p className="text-xs text-zinc-500">
                Joining as a guest gives you temporary access. You can upgrade to a full account anytime.
              </p>
