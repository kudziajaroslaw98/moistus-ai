	...
	return (
		<article className='prose prose-invert prose-zinc max-w-none'>
			...
			<section id='section-1' className='scroll-mt-24'>
				...
				<p>
					By accessing or using Shiko (&quot;Service&quot;), you agree to be bound by these Terms of
					Service (&quot;Terms&quot;). If you do not agree to these Terms, you may not use the
					Service.
				</p>
				<p>
					You must be at least 16 years old (or 13 in jurisdictions where the GDPR does not apply) to
					use this Service. By using Shiko, you represent that you meet this age requirement.
				</p>
				<p>
			...
			<section id='section-2' className='scroll-mt-24'>
				...
				<ul>
					<li>
						<strong>Mind mapping tools</strong> — Create, organize, and visualize your ideas with
						various node types (text, tasks, code, images, questions, and more)
					</li>
					<li>
						<strong>AI-powered features</strong> — Get intelligent suggestions, answers, and
						connections powered by artificial intelligence
					</li>
					<li>
						<strong>Real-time collaboration</strong> — Work together with others on shared mind maps
						with live cursors and presence indicators
					</li>
					<li>
						<strong>Export capabilities</strong> — Export your work in various formats (PNG, SVG, PDF)
					</li>
				</ul>
				<p>
			...
			<section id='section-3' className='scroll-mt-24'>
				...
				<p>To use most features of Shiko, you must create an account. You can sign up using:</p>
				<ul>
				...
				<p>
					Some features, such as joining shared maps via room codes, may be available without creating
					an account. Anonymous users have limited functionality and their data may not be retained
			...
			<section id='section-4' className='scroll-mt-24'>
				...
				<p>
					Payments are processed by Polar.sh, our third-party payment processor. By subscribing, you
					agree to Polar&apos;s terms of service. We do not store your payment card information.
				</p>

				<h3>4.4 Billing Cycle</h3>
				<p>
					Subscriptions are billed in advance on a monthly or annual basis. Your subscription will
					automatically renew at the end of each billing period unless you cancel.
				</p>
				...
				<ul>
					...
					<li>
						If you exceed Free plan limits, you may need to delete content or upgrade to continue
						using the Service
					</li>
				</ul>
				...
				<h3>4.6 Refunds</h3>
				<p>
					We generally do not provide refunds for subscription fees. However, we may consider refund
					requests on a case-by-case basis for exceptional circumstances. Contact us at{' '}
					<a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a> for assistance.
				</p>

				<h3>4.7 Price Changes</h3>
				<p>
					We may change our prices at any time. For existing subscribers, price changes will take
					effect at the start of the next billing cycle after 30 days&apos; notice.
				</p>
			</section>
			...
			<section id='section-5' className='scroll-mt-24'>
				...
				<ul>
					...
					<li>
						Post content that is defamatory, harassing, threatening, or promotes violence or
						discrimination
					</li>
					<li>Share explicit or adult content without appropriate safeguards</li>
				...
				<p>
					We implement rate limits to ensure fair usage and service stability. Excessive use that
					impacts other users or our infrastructure may result in temporary or permanent restrictions.
				</p>
			</section>
			...
			<section id='section-6' className='scroll-mt-24'>
				...
				<h3>6.1 Ownership</h3>
				<p>
					You retain ownership of all content you create using Shiko (&quot;User Content&quot;). We
					do not claim ownership of your mind maps, nodes, or other content.
				</p>

				<h3>6.2 License to Shiko</h3>
				<p>
					By using the Service, you grant us a limited, worldwide, non-exclusive, royalty-free
					license to:
				</p>
				<ul>
					<li>Store and display your content to you and your authorized collaborators</li>
				...
				<p>
					When you use AI features, your content (such as node text and map structure) is sent to our
					AI provider (OpenAI) for processing. By using AI features, you consent to this data
					transfer. See our <Link href='/privacy'>Privacy Policy</Link> for details.
				</p>

				<h3>6.4 Content Responsibility</h3>
				<p>
					You are solely responsible for your User Content. We do not endorse or guarantee the
					accuracy, completeness, or usefulness of any User Content.
				</p>

				<h3>6.5 Content Removal</h3>
				<p>
					We reserve the right to remove or disable access to content that violates these Terms or
			...
			<section id='section-7' className='scroll-mt-24'>
				...
				<p>
					The Service, including its design, features, code, and documentation, is owned by Shiko and
					protected by intellectual property laws. You may not copy, modify, or distribute any part
					of the Service without our permission.
				</p>

				<h3>7.2 Trademarks</h3>
				<p>
					&quot;Shiko&quot; and our logo are trademarks. You may not use our trademarks without prior
					written consent.
				</p>
				...
				<p>
					...
					royalty-free license to use and incorporate that feedback without obligation to you.
				</p>
			</section>
			...
			<section id='section-8' className='scroll-mt-24'>
				...
				<p>
					Shiko uses artificial intelligence (powered by OpenAI) to provide suggestions, answers, and
					other features. You understand that:
				</p>
				<ul>
					<li>AI-generated content may not be accurate, complete, or appropriate for your needs</li>
					<li>You are responsible for reviewing and verifying any AI-generated content</li>
					<li>AI features may not be available at all times due to third-party service limitations</li>
				</ul>

				<h3>8.2 Data Sent to AI</h3>
				<p>When you use AI features, the following data may be sent to OpenAI:</p>
				<ul>
					<li>Mind map structure (node relationships)</li>
					<li>Node content (text, not images or files)</li>
					<li>Your chat messages and conversation history (within the session)</li>
				</ul>

				<h3>8.3 No Guarantees</h3>
				<p>
					We make no guarantees about the quality, accuracy, or availability of AI features. AI
					capabilities may change as underlying models are updated.
				</p>
			...
			<section id='section-9' className='scroll-mt-24'>
				...
				<p>
					The Service may contain links to or integrations with third-party websites and services. We
					do not control or endorse these third parties and are not responsible for their content,
					privacy practices, or terms.
				</p>
				<p>
					Your use of third-party services (including OAuth providers like Google and GitHub) is
			...
			<section id='section-10' className='scroll-mt-24'>
				...
				<p>
					We do not guarantee that the Service will meet your requirements or that any errors will be
			...
			<section id='section-11' className='scroll-mt-24'>
				...
				<p>
					TO THE MAXIMUM EXTENT PERMITTED BY LAW, SHIKO AND ITS AFFILIATES, OFFICERS, EMPLOYEES, AND
			...
			<section id='section-12' className='scroll-mt-24'>
				...
				<p>
					You agree to indemnify, defend, and hold harmless Shiko and its affiliates from any claims,
			...
			<section id='section-13' className='scroll-mt-24'>
				...
				<p>
					...
					us. Upon termination, your right to use the Service will cease immediately.
				</p>
				...
				<ul>
					...
					<li>
						Your User Content may be deleted (we recommend exporting your data before termination)
					</li>
					<li>
						Provisions that should survive termination (such as Limitation of Liability and
			...
			<section id='section-14' className='scroll-mt-24'>
				...
				<p>
					...
					principles. For EU users, mandatory consumer protection laws of your country of residence
					may also apply.
				</p>
				...
				<p>
					...
					<a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a> to attempt to resolve the dispute
					informally. We will try to resolve disputes within 30 days.
				</p>

				<h3>14.3 Jurisdiction</h3>
				<p>
					Any disputes that cannot be resolved informally shall be subject to the exclusive
					jurisdiction of the courts in Poland, except where consumer protection laws grant you the
					right to bring proceedings in your country of residence.
				</p>
			</section>
			...
			<section id='section-15' className='scroll-mt-24'>
				...
				<p>
					Your continued use of the Service after the changes take effect constitutes acceptance of
					the new Terms. If you do not agree to the changes, you must stop using the Service.
				</p>
			</section>
			...
			<section id='section-16' className='scroll-mt-24'>
				...
				<p>
					...
					entire agreement between you and Shiko regarding the Service.
				</p>
