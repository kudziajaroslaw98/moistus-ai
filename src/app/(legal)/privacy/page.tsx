	...
	return (
		<article className='prose prose-invert prose-zinc max-w-none'>
			...
			<section id='section-1' className='scroll-mt-24'>
				...
				<p>
					Shiko (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) is committed to protecting your
					privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your
					information when you use our AI-powered mind mapping platform.
				</p>
				<p>
					We are based in Poland and operate under the European Union&apos;s General Data Protection
					Regulation (GDPR). We also comply with the California Consumer Privacy Act (CCPA) for our
					users in California.
				</p>
				<p>
					By using Shiko, you agree to the collection and use of information in accordance with this
			...
			<section id='section-2' className='scroll-mt-24'>
				...
				<ul>
					<li>
						<strong>Email address</strong> — Required for account identification and communication
					</li>
					<li>
						<strong>Password</strong> — Stored in encrypted (hashed) form; we never have access to
					...
					<li>
						<strong>Profile information</strong> — Optional bio and preferences you choose to provide
					</li>
				</ul>
				...
				<p>
					We do not receive or store your OAuth provider passwords. Authentication is handled
					securely by the respective providers.
				</p>
				...
				<ul>
					<li>
						<strong>Mind maps</strong> — Including titles, descriptions, and organizational structure
					</li>
					<li>
						<strong>Nodes</strong> — All node types (text, tasks, code, images, questions, etc.) and
						their content
					</li>
					<li>
					...
					<li>
						<strong>Comments</strong> — Discussion threads and messages on shared maps
					</li>
				</ul>
				...
				<ul>
					<li>
						<strong>AI feature usage</strong> — We track how many AI suggestions you use for billing
						purposes
					</li>
					<li>
						<strong>Subscription status</strong> — Your plan type and billing period
					</li>
				</ul>
				...
				<ul>
					<li>Payment card details (handled entirely by our payment processor, Polar)</li>
					<li>Phone numbers or physical addresses</li>
					<li>Location or GPS data</li>
					<li>Device fingerprints for tracking</li>
					<li>
						We do not use analytics services like Google Analytics, Mixpanel, or similar tracking
						tools
					</li>
				</ul>
			</section>
			...
			<section id='section-3' className='scroll-mt-24'>
				...
				<ul>
					<li>
						<strong>Provide our service</strong> — Store and sync your mind maps across devices, enable
						real-time collaboration
					</li>
					<li>
						<strong>Process AI features</strong> — Send relevant content to our AI provider (OpenAI)
						to generate suggestions and answers
					</li>
					<li>
						<strong>Process payments</strong> — Manage subscriptions through our payment processor
					</li>
					<li>
						<strong>Communicate with you</strong> — Send service-related emails (account verification,
						password resets, billing notifications)
					</li>
					<li>
						<strong>Improve our service</strong> — Understand how features are used to make
						improvements
					</li>
					<li>
						<strong>Ensure security</strong> — Detect and prevent fraud, abuse, and security threats
					</li>
					<li>
						<strong>Comply with legal obligations</strong> — Respond to legal requests and enforce our
						terms
					</li>
				</ul>
			</section>
			...
			<section id='section-4' className='scroll-mt-24'>
				...
				<p>
					Processing necessary to provide you with our service, including account management, content
					storage, and collaboration features.
				</p>

				<h3>4.2 Legitimate Interests</h3>
				<p>
					Processing necessary for our legitimate interests, including service security, fraud
					prevention, and service improvements, where these interests are not overridden by your
					rights.
				</p>

				<h3>4.3 Consent</h3>
				<p>
					For optional features or communications, we rely on your consent, which you can withdraw at
					any time.
				</p>

				<h3>4.4 Legal Obligation</h3>
				<p>Processing necessary to comply with legal requirements, such as tax and accounting laws.</p>
			</section>
			...
			<section id='section-5' className='scroll-mt-24'>
				...
				<p>
					<strong>We do not sell your personal data.</strong> We share information only in the
					...
					<table className='w-full text-sm'>
						<thead>
							<tr className='border-b border-border-subtle'>
								<th className='text-left py-3 px-4 text-text-primary font-semibold'>Provider</th>
								<th className='text-left py-3 px-4 text-text-primary font-semibold'>Purpose</th>
								<th className='text-left py-3 px-4 text-text-primary font-semibold'>Location</th>
								<th className='text-left py-3 px-4 text-text-primary font-semibold'>Data Shared</th>
							</tr>
						</thead>
						<tbody className='text-text-secondary'>
							<tr className='border-b border-border-subtle/50'>
								<td className='py-3 px-4'>Supabase</td>
								<td className='py-3 px-4'>Database, Authentication, Real-time sync</td>
				...
				<p>
					When you share a mind map, collaborators can see your display name, avatar, and real-time
					activity (cursor position, selected nodes). Your email is not shared with collaborators
					unless you explicitly include it in your profile.
				</p>
				...
				<p>
					If Shiko is involved in a merger, acquisition, or sale of assets, your information may be
			...
			<section id='section-6' className='scroll-mt-24'>
				...
				<ul>
					...
					<li>
						<strong>AI chat history</strong> — Chat conversations with AI are ephemeral and are not
						stored on our servers after your session ends
					</li>
					<li>
						<strong>Backups</strong> — Backups may retain deleted data for up to 90 days for disaster
						recovery purposes
					</li>
				</ul>
			</section>
			...
			<section id='section-7' className='scroll-mt-24'>
				...
				<p>
					You can request a copy of the personal data we hold about you. We provide data export
				...
				<p>
					You can request deletion of your account and associated data. This can be done through your
					account settings or by contacting us.
				</p>

				<h3>7.4 Right to Data Portability</h3>
				<p>
					You can export your mind maps and data in standard formats (JSON) for use with other
					services.
				</p>
				...
				<p>
					...
					<a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a>. We will respond within 30 days (or
			...
			<section id='section-8' className='scroll-mt-24'>
				...
				<p>
					Some of our service providers are located in the United States. When we transfer your data
					outside the European Economic Area (EEA), we ensure appropriate safeguards are in place:
				</p>
				<ul>
					<li>
						<strong>Standard Contractual Clauses (SCCs)</strong> — Our agreements with US-based
						providers include EU-approved contractual safeguards
					</li>
					<li>
						<strong>Adequacy decisions</strong> — Where applicable, we rely on EU adequacy decisions
					</li>
				</ul>
				<p>
			...
			<section id='section-9' className='scroll-mt-24'>
				...
				<ul>
					...
					<li>
						<strong>Password hashing</strong> — Passwords are hashed using industry-standard algorithms
						(bcrypt)
					</li>
					<li>
						<strong>Row-level security</strong> — Database access is controlled at the row level to
						ensure you can only access your own data
					</li>
					<li>
						<strong>Access controls</strong> — We limit employee access to personal data on a
						need-to-know basis
					</li>
					<li>
						<strong>Regular updates</strong> — We keep our systems and dependencies updated to address
			...
			<section id='section-10' className='scroll-mt-24'>
				...
				<p>
					Shiko is not intended for children under 16 years of age (or 13 in jurisdictions where the
					GDPR does not apply). We do not knowingly collect personal information from children.
				</p>
				<p>
					If you are a parent or guardian and believe your child has provided us with personal
					information, please contact us at <a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a>.
			...
			<section id='section-11' className='scroll-mt-24'>
				...
				<p>
					We encourage you to review this policy periodically. Your continued use of Shiko after
