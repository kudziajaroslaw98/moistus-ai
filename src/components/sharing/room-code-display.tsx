...
import { Clock, Copy, QrCode, RefreshCw, Users, X, ExternalLink } from "lucide-react";
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <Badge 
              variant="outline" 
              className={`text-xs ${
                token.permissions.role === 'editor' ? 'border-green-500 text-green-400' :
                token.permissions.role === 'commenter' ? 'border-yellow-500 text-yellow-400' :
