...
className='mb-3' style={{
				...
				li: ({children}) => (
					<li
className='flex items-start gap-2' style={{
						color: GlassmorphismTheme.text.medium,
						fontSize: '14px',
						lineHeight: 1.6,
					}}
...
className={className} style={{
					...
					return (
						<code
className='px-1.5 py-0.5 rounded' style={{
				...
				pre: ({children}) => (
					<pre
className='p-3 rounded-md mb-3 overflow-x-auto' style={{
				...
				blockquote: ({children}) => (
					<blockquote
className='pl-4 py-2 my-3 italic' style={{
