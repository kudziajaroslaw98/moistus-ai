...
const testimonials = [
	{
		...
		avatar: 'SC',
		content:
			'Moistus AI has completely transformed how our team brainstorms and manages projects. The AI suggestions are genuinely helpful, not just gimmicks.',
		rating: 5,
	},
	{
		id: 2,
		...
		avatar: 'MR',
		content:
			"The semantic search feature is a game-changer. I can find connections between ideas I wrote months apart. It's like having a second brain that never forgets.",
		rating: 5,
	},
	{
		id: 3,
		...
		avatar: 'EW',
		content:
			"I've tried every mind mapping tool out there. Moistus AI is the first one that actually helps me think better, not just organize what I already know.",
		rating: 5,
	},
	{
		id: 4,
		...
		avatar: 'DP',
		content:
			'The ability to add code snippets and technical diagrams directly into mind maps makes this perfect for technical planning. Real-time collaboration is flawless.',
		rating: 5,
	},
];
	...
	return (
		...
		>
			<div className='rounded-2xl border border-zinc-800 bg-zinc-900/50 backdrop-blur-sm p-6'>
				<div
					className={`inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${stat.color} p-2.5 mb-4`}
				>
		...
		>
			...
			<div className='relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
				...
				>
					...
					>
						See why teams and individuals choose Moistus AI to transform their
						thinking process.
					</motion.p>
				</motion.div>
