...
const QuestionNodeForm = forwardRef<{ getFormData: () => Partial<NodeData> | null }, QuestionNodeFormProps>(
  ({ initialData }, ref) => {
    ...
    return (
      <div className="flex flex-col gap-2">
        <label htmlFor="questionContent" className="text-sm font-medium text-zinc-400">Question Content</label>
        <textarea
          id="questionContent"
          value={content}
