...
// // DEPRECATED: History logic is now managed in Zustand (see mind-map-store.tsx)
// import { useAppStore } from '@/contexts/mind-map/mind-map-store';

// /**
//  * Proxy hook for backward compatibility. Prefer using useAppStore directly.
//  */
// export function useMindMapHistory(): Omit<ReturnType<typeof useAppStore>, 'supabase' | 'mapId' | 'mindMap' | 'reactFlowInstance' | 'nodes' | 'edges' | 'setNodes' | 'setEdges'> {
//   // Only expose history-related state/actions for compatibility
//   const {
//     history,
//     historyIndex,
//     isReverting,
